...
//----------------------------------------------------------		
		...
		Produto roupaCama1 = new Produto(null, "Lençol Macio", "Um lençol muito macio", 25.50);
		Produto roupaCama2 = new Produto(null, "Fronha boa", "Um fronha que combina com o lençol", 10.35);
		Produto roupaCama3 = new Produto(null, "Cobertor Macio", "Um Cobertor macio", 38.30);
//----------------------------------------------------------
		Produto banho1 = new Produto(null, "lencolBanho", "Um lençol muito macio", 25.50);
		Produto banho2 = new Produto(null, "Toalhão", "Um lençol muito macio", 25.50);
		Produto banho3 = new Produto(null, "Toalha Macio", "Um lençol muito macio", 25.50);
		Produto banho4 = new Produto(null, "Toalhete Macia", "Um lençol muito macio", 25.50);
		Produto banho5 = new Produto(null, "Tapete de Banhoa ", "Um lençol muito macio", 25.50);
		
		Produto branco1 = new Produto(null, "Jogo de Cama Branco", "Jogo de Branco Caro", 32.00);
		Produto lencois = new Produto(null, "Lençol Branco", "Lençol Branco Muito Caro", 28.00);
		Produto lencois1 = new Produto(null, "Lençol11 Branco", "Lençol Branco Muito Caro", 28.00);
